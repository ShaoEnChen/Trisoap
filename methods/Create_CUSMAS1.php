...
<div class="sign-block">
    ...
    <form name="form" method="post" action="Create_CUSMAS_finish.php">
        ...
        <label for="phonenumber"><input type="text" name="TEL" value="<?php echo $TEL;?>" placeholder="聯絡電話(可不填)" id="phonenumber"/></label>
        <label for="address"><input type="text" name="CUSADD" value="<?php echo $CUSADD;?>" placeholder="通訊地址(可不填)" id="address"/></label> 
        <label for="uniformnum"><input type="text" name="TAXID" value="<?php echo $TAXID;?>" placeholder="統一編號(可不填)" id="uniformnum"/></label>
        <label for="skin">
            <div class="q-select">
