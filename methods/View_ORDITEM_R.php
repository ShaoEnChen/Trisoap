...
if($EMAIL != null){
        if($CUSIDT == 'A'){
                $ORDNO = $_POST['ORDNO'];
                echo "<form name=\"form\" method=\"post\" action=\"Update_ORDMAS_R_finish.php\">";
