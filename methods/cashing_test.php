...
try {
    ...
    $obj->ServiceURL = "https://payment-stage.allpay.com.tw/Cashier/AioCheckOut/V2"; //for testing
    //for official: https://payment.allpay.com.tw/Cashier/AioCheckOut/V2
    ...
    $obj->Send['ChoosePayment']     = PaymentMethod::Credit, WebATM, ATM;       //Payment Method
