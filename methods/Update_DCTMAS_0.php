                            ...
                            <div id="all" class="tab-pane fade in active">                        
                                <table class="table table-hover">
                                    ...
                                    <?
                                        ...
                                        if($keytype == null){
                                            $queryDCTMAS = "SELECT * FROM DCTMAS WHERE ACTCODE = '1' AND DCTSTAT = '0' ORDER BY CREATEDATE DESC";
                                        }
                                        else{
                                            $queryDCTMAS = "SELECT * FROM DCTMAS WHERE ACTCODE = '1' AND DCTSTAT = '0' AND $keytype = '$keyvalue' ORDER BY CREATEDATE DESC";
                                        }
