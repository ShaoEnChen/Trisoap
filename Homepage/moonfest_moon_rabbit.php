          ...
          <div id="carousel-shop" class="carousel slide">
            <div class="col-lg-6 carousel-outer">
              ...
              <div class="carousel-inner">
                <div class="item active"><img src="img/product/moonfest/moonfest_moon_rabbit.jpg" alt="產品封面照片"></div>
              </div>
              <!-- Controls-->
              ...
              <ol class="carousel-indicators mCustomScrollbar">
                <li data-target="#carousel-shop" data-slide-to="0" class="active"><img src="img/product/moonfest/moonfest_moon_rabbit.jpg" alt="產品封面小圖"></li>
              </ol>
            </div>
