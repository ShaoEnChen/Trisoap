...
<html>
  <head>
    ...
    <title>中秋混搭單品皂絲組｜三三吾鄉手工皂Trisoap</title>
    <meta name="description" content="月兔在台灣在地作物當中嬉笑，透過全暖色的設計帶給你三三吾鄉的絕佳精神。可根據顧客的需求而選擇內容物的混搭風是經濟又實惠的團圓禮。">
    <!-- Bootstrap Core CSS-->
          ...
          <div id="carousel-shop" class="carousel slide">
            <div class="col-lg-6 carousel-outer">
              ...
              <div class="carousel-inner">
                <div class="item active"><img src="img/product/moonfest/moonfest_mixed.jpg" alt="產品封面照片"></div>
                <div class="item"><img src="img/product/moonfest/moonfest_mixed_inside.jpg" alt="產品照片1"></div>
              </div>
              <!-- Controls-->
              ...
              <ol class="carousel-indicators mCustomScrollbar">
                <li data-target="#carousel-shop" data-slide-to="0" class="active"><img src="img/product/moonfest/moonfest_mixed.jpg" alt="產品封面小圖"></li>
                <li data-target="#carousel-shop" data-slide-to="1"><img src="img/product/moonfest/moonfest_mixed_inside.jpg" alt="產品小圖1"></li>
              </ol>
            </div>
            ...
            <div class="col-lg-6 slide">
              ...
              <hr>
              <p>
                三三吾鄉臺東意象單皂  一入（釋迦、金針、米擇一）
                三三吾鄉旅用皂絲三入組 一式（洛神、金針、薑黃各一）

                *單品隨機出貨，如需指定單品項目，請於購買時加入備註，或加入三三吾鄉LINE@ ID: urr5353l
              </p>
              ...
              <form class="form-inline" method="post" action="../methods/Purchase_finish.php">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="ITEMNO" value="moon_box_3">
                </div>
