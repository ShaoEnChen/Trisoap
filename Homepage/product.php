...
<html lang="en">
  ...
  <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" class="top">
    ...
    <!-- Header-->
    <header data-background="img/jumbotrons/product_idea.jpg" class="intro introhalf">
      <!-- Intro Header-->
    ...
    <section id="news" class="section-small">
      <div class="container">
        ...
        <div class="row grid-pad">
          ...
          <div class="col-sm-6"><a href="product2.php"><img src="img/product/lily.jpg" alt="" class="img-responsive center-block">
          ...
          <div class="col-sm-6"><a href="product3.php"><img src="img/product/shakya.jpg" alt="" class="img-responsive center-block">
              <h5>釋迦手感果力皂 (釋迦皂）</h5></a>
          ...
          <div class="col-sm-6"><a href="product4.php"><img src="img/product/taitung.jpg" alt="" class="img-responsive center-block">
              <h5>三三臺東意象禮盒組</h5></a>
