          ...
          <div id="carousel-shop" class="carousel slide">
            <div class="col-lg-6 carousel-outer">
              ...
              <div class="carousel-inner">
                ...
                <div class="item"><img src="img/product/detail/string_roselle00.jpg" alt="產品照片0"></div>
              ...
              <ol class="carousel-indicators mCustomScrollbar">
                ...
                <li data-target="#carousel-shop" data-slide-to="1"><img src="img/product/detail/string_roselle00.jpg" alt="產品小圖0"></li>
                <li data-target="#carousel-shop" data-slide-to="2"><img src="img/product/detail/string_roselle01.jpg" alt="產品小圖1"></li>
                <li data-target="#carousel-shop" data-slide-to="3"><img src="img/product/detail/string_roselle02.jpg" alt="產品小圖2"></li>
              </ol>
            </div>
            ...
            <div class="col-lg-6 slide">
              ...
              <form class="form-inline" method="post" action="../methods/Purchase_finish.php">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="ITEMNO" value="product_ss_001">
                </div>
